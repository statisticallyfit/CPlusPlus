...
public:
    ...
    {}
    void set(int h, int m, int s) { hours = h; minutes = m; seconds = s; }
    ...
    long int toSeconds() {
        return ((long) seconds + minutes * 60 + hours * 3600);
    }

    bool isEqual(Time other) {
        return (hours == other.getHour() &&
    ...
    Time elapsedTime(Time other) {
        ...
        long double minSec = 60 * (hourMin - (int) hourMin); // get decimal part (min in hours form)
...
int main() {
    ...
    cout << "Test ++ PREFIX without return" << endl;
    cout << "Before: " << endl;
    cout << "t1 = "; t1.show(); cout << endl;
    ++t1;   // test
    cout << "After: " << endl;
    cout << "t1 = "; t1.show(); cout << endl << endl;


    t1.input(); cout << endl;
    cout << "Test ++ POSTFIX without return" << endl;
    cout << "Before: " << endl;
    cout << "t1 = "; t1.show(); cout << endl;
    t1++;   // test
    cout << "After: " << endl;
